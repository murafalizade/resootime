  ...
  const makeReservation = async () => {
    ...
    const req = {
      date:
        ...
        localDate.split("/")[0] +
        "T" +
        props.date.toLocaleString(formatDate.locale).split(",")[1].slice(1, 6),
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="ReservationCompleteModalLabel">
                ...
                <div>
                  ...
                  <p className="d-flex">
                    ...
                    <span className="d-flex mx-1 align-items-center">
                      <BiTimeFive />
                      {props.date.toLocaleString().split(",")[1].slice(0, 6)}
                    </span>
                    <span className="d-flex mx-1 align-items-center ">
                      <IoPeopleOutline />

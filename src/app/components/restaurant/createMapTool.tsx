        ...
        <div className="d-flex">
          ...
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[5]?.type, tableImages[5]?.count)
              }
        ...
        <div className="d-flex">
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[6]?.type, tableImages[6]?.count)
              }
          ...
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[7]?.type, tableImages[7]?.count)
              }
          ...
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[8]?.type, tableImages[8]?.count)
              }
        ...
        <div className="d-flex">
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[0]?.type, tableImages[0]?.count)
              }
          ...
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[1]?.type, tableImages[1]?.count)
              }
          ...
          <div className={`${styles.table_bar_item} w-75`}>
            <Image
              draggable={true}
              onDragEnd={(e) =>
                dragChecking(e, tableImages[2]?.type, tableImages[2]?.count)
              }
      ...
      <div className={styles.table_map}>
        <div className="bg-light d-flex p-2 justify-content-between">
          <div className="d-flex">
            ...
            <div>
              <button onClick={zoomOut} className="btn btn-primary mx-3">
                -
              </button>
              <button onClick={zoomIn} className="btn btn-primary mx-3">
                +
              </button>
            </div>
          </div>
          <div>
            <button className="btn btn-primary mx-3" onClick={onSaveTable}>
              Yadda saxla
            </button>
          </div>
        </div>

...
const Table = (props: TableProps) => {
  ...
  const chooseTable = () => {
    ...
    if (props.isEdit || props.table.is_full || props.table.is_full == undefined)
      return;
  ...
  return (
    <Draggable
      ...
      defaultPosition={{
        ...
        y: props.isEdit ? props.table.ycod : props.table.ycod + 530/props.table.size!,
      }}
    ...
    >
      ...
      >
        <div className="d-flex justify-content-between">
          {props?.isActive ? (
            <>
              <div style={{ cursor: "pointer" }} onClick={onDeleteTable}>
                <MdDeleteSweep color="white" size={20} />
              </div>
              <div>
                <GrRotateLeft onClick={rotateTable} color="white" size={20} />
              </div>
            </>
          ) : null}
        </div>
        ...
        <div style={{ transform: `rotate(${deg}deg)` }} onClick={chooseTable}>

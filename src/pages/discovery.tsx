        ...
        <main>
            ...
            <div className="container">
              <div className="row">
                <div className="col-12 col-lg-6 d-flex flex-column justify-content-center">
                  <h2 className={`fw-bold word-break ms-2 ${styles.heading}`}>
                    Restoran rezervasiyası <br /> və müştəri məmnuniyyəti
                    <br /> bir arada
                  </h2>
          ...
          <section className={`bg-light py-md-5 ${styles.sect}`}>
            <div className="container mt-4">
              <h2 className="text-center">Rezervasiya İdarəetmə Sistemi</h2>
              <div className="row mt-5">
                <div className="col-12 col-md-4">
                  ...
                  <p>
                    Zəng ilə rezervasiya qəbul etmək artıq geridə qaldı. İndi,
                    rezervasiyaları 24/7{" "}
                    <i>
                      <b>onlayn</b>
                    </i>{" "}
                    qəbul edərək, işinizi asanlaşdırmağın və vaxtınıza qənaət
                    etməyin zamanıdır.
                  </p>
                </div>
                <div className="col-12 col-md-4">
                  ...
                  <p>
                    Rezervasiya edən bütün müştərilərinizin məlumatlarını və
                    restoranınız haqda rəylərini təhlil edərək onlara daha yaxşı
                ...
                <div className="col-12 col-md-4">
                  ...
                  <p>
                  Rezervasiya edən müştərilərə endirimlər təklif edərək, daimi müştərilər qazanın
                  </p>
                </div>
              </div>
              <div className="d-flex justify-content-center">
                ...
                >
                  Əyləşəcəyi masanı özü seçən müştərilərin restorandan daha
                  məmnun qaldığını bilirdiniz?
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="container py-md-4">
              ...
              <div className="row mt-5">
                <div className="col-12 col-md-4">
                  ...
                  <p>
                    Müştərilər restoranın sadələşdirilmiş xəritəsi üzərindən
                    əyləşmək istədiklərini <b>“masa”</b>-nı rezerv edə
                    biləcəklər{" "}
                  </p>
                </div>
                <div className="col-12 col-md-4">
                  ...
                  <p>
                    Xatırladıcı bildirişlər sayəsində müştərilərinizin etdiyi
                    rezervasiyaları unutmağının və gecikmələrin qarşısını
                    alaraq, yaranan qarışıqlığı aradan qaldıra biləcəksiniz
                  </p>
                </div>
                <div className="col-12 col-md-4">
                  <h3>
                  ...
                  <p>
                    Bir kliklə rezervasiyanı ləğv etməyin mümkünlüyü,
                    rezervasiya edib, lakin <del>restorana gəlməyən</del>{" "}
                    müştərilərin sayını azaldacaq və masalarınız hər zaman dolu
                    olacaqdır
                  </p>
                </div>
              </div>
          ...
          >
            <div className="container">
              <div className={`row my-4 p-4 mt-5 ${styles.number_field}`}>
                ...
                <div className="p-0 m-0 mt-2 mt-md-0 col-12 col-md-6 d-flex justify-content-md-end justify-content-center">
                  ...
                  >
                    <ImPhone color="#6A5DDF" className="fs-3 mt-1 me-2" />
                    +994 50 850 70 09
                  </a>
                </div>
              </div>
